...
class TrainerControllerTests {
    ...
    final String TEST_FIRST_NAME = "placeholderFirstName";
    final String TEST_LAST_NAME = "placeholderLastName";
    final String TEST_DESCRIPTION = "placeholderDescription";
    final String TEST_IMAGE = "placeholderImage";
    //TrainerCommand trainerCommand = new TrainerCommand(TEST_FIRST_NAME, TEST_LAST_NAME, TEST_DESCRIPTION, TEST_IMAGE);
